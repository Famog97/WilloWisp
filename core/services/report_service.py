"""
core/services/report_service.py  (M2.5 — relocated from iscs_reports.py)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Reporting core service for the ISCS Closed-Loop Framework. Generates consolidated
HTML Suite Dashboards and structured Excel workbooks. ``iscs_reports`` re-exports
``ReportManager`` as a shim.

Note: the internal decomposition of ``normalize_results`` (→ shape mappers) and
``_write_html_report`` (→ LegacyReportComposer + report widgets) is a planned
refinement (M2.5 cont); this step is the verbatim relocation into the core layer.
No UI/OS-automation imports.
"""
